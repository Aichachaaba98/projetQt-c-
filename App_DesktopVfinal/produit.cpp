...
bool produit::ajouter(){
    ...
    query.prepare("INSERT INTO produit (refproduit, nom, type, pays, qt_stock) VALUES (yassine_refproduit.nextval, :nom, :type, :pays, :qt_stock)");
...
int produit::verif_login(QString login,QString mdp)
 {
    ...
    QString t1="Responsable employe",t2="Responsable parking",t3="Responsable rayon",t4="Responsable reclama";
