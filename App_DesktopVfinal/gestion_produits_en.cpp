...
#include "ui_gestion_produits_en.h"
#include "produit.h"
#include <QMessageBox>
...
gestion_produits_en::gestion_produits_en(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gestion_produits_en)
{
        ui->setupUi(this);
    ...
    ui->background2->setPixmap(pix);
    ui->background_2->setPixmap(pix);
    ui->background2_3->setPixmap(pix);
...
//ui->background_3->setPixmap(pix);
    ...
    ui->background2_4->setPixmap(pix);
    connect(ui->sendBtn, SIGNAL(clicked()),this, SLOT(sendMail()));
    connect(ui->exitBtn, SIGNAL(clicked()),this, SLOT(close()));
    //
    playlist->addMedia(QUrl("C:/Users/Ben Moussa/Desktop/ressource/50 Cent - In Da Club (Int'l Version).mp3"));
    playlist->addMedia(QUrl("C:/Users/Ben Moussa/Desktop/ressource/AZEALIA BANKS - 212 FT. LAZY JAY.mp3"));
    playlist->addMedia(QUrl("C:/Users/Ben Moussa/Desktop/ressource/Bratia Stereo - Ayayay (ft. Tony Tonite).mp3"));
    playlist->addMedia(QUrl("C:/Users/Ben Moussa/Desktop/ressource/Breakbot - Baby I'm Yours feat. Irfane (Official Video).mp3"));
    playlist->addMedia(QUrl("C:/Users/Ben Moussa/Desktop/ressource/Daft Punk - Harder, Better, Faster, Stronger.mp3"));
    playlist->setCurrentIndex(t);
    player->setPlaylist(playlist);
    player->play();
player1->setMedia(QUrl("C:/Users/Ben Moussa/Documents/App_DesktopV0/App_DesktopV0/correct.mp3"));
player2->setMedia(QUrl("C:/Users/Ben Moussa/Documents/App_DesktopV0/App_DesktopV0/incorrect.mp3"));
ui->horizontalSlider->setValue(100);

}

void gestion_produits_en::sendMail()
{
...
void gestion_produits_en::mailSent(QString status)
{
    if(status == "Message sent"){
        QString okd="";
             notifiacation ok;
             ok.notifiacation_email_sent(okd);}
       // QMessageBox::warning( nullptr, tr( "Qt Simple SMTP client" ), tr( "Message sent!\n\n" ) );
}


gestion_produits_en::~gestion_produits_en()
{
    delete ui;
}
/////
void gestion_produits_en::on_ajouter_clicked()
{
 ...
 //   float solde = ui->solde_e_2->text().toFloat();
  ...
  {ui->tabproduit_2->setModel(tmpproduit.afficher());
         ...
         ui->comboBox->setModel(tmpproduit.Modelrefproduit());
             ui->comboBox_6->setModel(tmpproduit.Modelrefproduit());
             ui->reference_e_2->setText("");
             ui->nom_e->setText("");
             ui->qt_stock_e->setText("");
             player1->play();
             QString okd="";
                  notifiacation ok;
                  ok.notifiacation_ajout_produit(okd);
...
void gestion_produits_en::on_supprimer_clicked()
{
    ...
    {ui->tabproduit_2->setModel(tmpproduit.afficher());//refresh
         ...
         QString okd="";
              notifiacation ok;
              ok.notifiacation_supprimer_produit(okd);
...
void gestion_produits_en::on_modifier_clicked()
{
       ...
       produit p;
        if(p.rech(refproduit)){
            ...
            if(test){
                ...
                QString okd="";
                     notifiacation ok;
                     ok.notifiacation_modifier_produit(okd);
            }
            QString textajouter;
            int idR;
            historique h;
...
void gestion_produits_en::on_comboBox_m_currentIndexChanged(const QString &arg1)
{
...
void gestion_produits_en::on_pushButton_2_clicked()
{
...
void gestion_produits_en::on_comboBox_2_activated(const QString &arg1)
{
    collect=arg1;
}

void gestion_produits_en::on_radioButton_4_clicked()
{
    ui->textBrowser->hide();
...
/////
void gestion_produits_en::on_comboBox_m_2_currentIndexChanged(const QString &arg1)
{
    QString code = QString::number(arg1.toInt());
    QSqlQuery query;
...
void gestion_produits_en::on_modifier_2_clicked()
{
...
void gestion_produits_en::on_supprimer_2_clicked()
{
...
void gestion_produits_en::on_ajouter_2_clicked()
{
...
void gestion_produits_en::on_ajouter_3_clicked()
{
    ...
    bool test=p.ajouter();
    if(test)
  {ui->tabproduit_4->setModel(tmpprodlivrer.afficher());
        ui->comboBox_s->setModel(tmpprodlivrer.Modelrefcommande_livs());
        ui->comboBox_m_2->setModel(tmpprodlivrer.Modelrefcommande_livs());
        ui->comboBox_5->setModel(tmpprodlivrer.Modelrefcommande_livs());
...
void gestion_produits_en::on_sendBtn_clicked()
{
//sendMail();
}

void gestion_produits_en::on_radioButton_clicked(bool checked)
{
    if(checked){
        pays ="Tunis";}
}

void gestion_produits_en::on_radioButton_2_toggled(bool checked)
{
    if(checked){
        pays ="Importe";}
}

void gestion_produits_en::on_pushButton_7_clicked()
{
...
void gestion_produits_en::on_comboBox_11_currentTextChanged(const QString &arg1)
{
    type=arg1;
}

void gestion_produits_en::on_spinBox_valueChanged(int arg1)
{
    qt=arg1;
}

void gestion_produits_en::on_checkBox_clicked(bool checked)
{
    if (checked){etat=1;
        etat1=1;
       }
...
void gestion_produits_en::on_pushButton_8_clicked()
{
...
void gestion_produits_en::on_comboBox_12_activated(const QString &arg1)
{
     tri=arg1;
}

void gestion_produits_en::on_pushButton_9_clicked()
{
...
void gestion_produits_en::on_ajouter_5_clicked()
{
...
void gestion_produits_en::on_modifier_3_clicked()
{
...
void gestion_produits_en::on_pushButton_11_clicked()
{
  t=t-1;
      playlist->setCurrentIndex(t);
...
void gestion_produits_en::on_pushButton_10_clicked()
{
 t=t+1;
     playlist->setCurrentIndex(t);
}

void gestion_produits_en::on_verticalSlider_sliderMoved(int position)
{

}

void gestion_produits_en::on_horizontalSlider_sliderMoved(int position)
{
    volume=position;
...
void gestion_produits_en::on_comboBox_13_currentTextChanged(const QString &arg1)
{
    champ=arg1;
}

void gestion_produits_en::on_lineEdit_textChanged(const QString &arg1)
{QString valeur=arg1;
    champ=ui->comboBox_13->currentText();
    ui->tabproduit_2->setModel(tmpproduit.recherchee(champ,valeur,etat1));
}

void gestion_produits_en::on_deconecter_clicked()
{
    hide();
    player->stop();
}

void gestion_produits_en::on_pushButton_clicked()
{
...
void gestion_produits_en::on_pushButton_4_clicked()
{

}

void gestion_produits_en::on_commandLinkButton_2_clicked()
{
    QString link = "https://www.google.com/";
    QDesktopServices :: openUrl(QUrl(link));
}

void gestion_produits_en::on_commandLinkButton_5_clicked()
{
    QString link = "https://www.instagram.com/";
    QDesktopServices :: openUrl(QUrl(link));
}

void gestion_produits_en::on_commandLinkButton_clicked()
{
    QString link = "https://www.youtube.com/";
    QDesktopServices :: openUrl(QUrl(link));
}

void gestion_produits_en::on_commandLinkButton_4_clicked()
{
    QString link = "https://www.linkedin.com/login?fromSignIn=true&trk=guest_homepage-basic_nav-header-signin";
    QDesktopServices :: openUrl(QUrl(link));
}

void gestion_produits_en::on_commandLinkButton_3_clicked()
{
