...
player3->setMedia(QUrl("C:/Users/Ben Moussa/Documents/App_DesktopV0/App_DesktopV0/correct.mp3"));
}
...
void Gestion_produits::on_comboBox_13_currentTextChanged(const QString &arg1)
{
    champ=arg1;
}

void Gestion_produits::on_lineEdit_textChanged(const QString &arg1)
{QString valeur=arg1;
    champ=ui->comboBox_13->currentText();
    ui->tabproduit_2->setModel(tmpproduit.recherchee(champ,valeur,etat1));
}

void Gestion_produits::on_deconecter_clicked()
{
    hide();
    player->stop();
}

void Gestion_produits::on_pushButton_clicked()
{
...
void Gestion_produits::on_pushButton_4_clicked()
{

}

void Gestion_produits::on_commandLinkButton_2_clicked()
{
    QString link = "https://www.google.com/";
    QDesktopServices :: openUrl(QUrl(link));
}

void Gestion_produits::on_commandLinkButton_5_clicked()
{
    QString link = "https://www.instagram.com/";
    QDesktopServices :: openUrl(QUrl(link));
}

void Gestion_produits::on_commandLinkButton_clicked()
{
    QString link = "https://www.youtube.com/";
    QDesktopServices :: openUrl(QUrl(link));
}

void Gestion_produits::on_commandLinkButton_4_clicked()
{
    QString link = "https://www.linkedin.com/login?fromSignIn=true&trk=guest_homepage-basic_nav-header-signin";
    QDesktopServices :: openUrl(QUrl(link));
}

void Gestion_produits::on_commandLinkButton_3_clicked()
{
