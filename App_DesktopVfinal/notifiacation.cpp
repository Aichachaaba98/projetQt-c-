...
void notifiacation::notifiacation_verif_quantite1(QString id)
{
    ...
    //notifyIcon->setVisible(1);
    notifyIcon->show();
    notifyIcon->showMessage("News My Liege !","Produit épuisé.",QSystemTrayIcon::Information,15000);
//num++;
}

void notifiacation::notifiacation_verif_quantite2(QString id)
{
    ...
    //notifyIcon->setVisible(1);
    notifyIcon->show();
    notifyIcon->showMessage("News My Liege !","Produit en stock.",QSystemTrayIcon::Information,15000);
//num++;
}
...
void notifiacation::notifiacation_produit()
{
    ...
    //notifyIcon->setVisible(1);
    notifyIcon->show();
    notifyIcon->showMessage("Gestion de stock","le produit est epuisé",QSystemTrayIcon::Information,15000);
//num++;
}
